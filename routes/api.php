...
Route::prefix('risk-weight')->group(function ($router) {
    ...
    Route::patch('/{riskId}', [App\Http\Controllers\RiskWeightController::class, 'updateRiskWeight'])->name('updateRiskWeight');
...
Route::prefix('users')->group(function ($router) {
    ...
    Route::patch('/{userId}', [App\Http\Controllers\UserController::class, 'updateUser'])->name('updateUser');
...
Route::prefix('transaction')->group(function ($router) {
    Route::post('/', [App\Http\Controllers\FraudDetectionController::class, 'evaluateTransaction'])->name('evaluateTransaction');
});
